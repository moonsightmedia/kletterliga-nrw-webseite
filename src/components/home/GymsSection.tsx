            ...
            >
              {gyms.map((gym) => (
                ...
                >
                  ...
                  <h3 className="mb-2 min-h-[3.2rem] max-w-full flex-shrink-0 font-headline text-[0.92rem] leading-[0.98] tracking-[-0.01em] text-primary sm:text-[1.18rem] md:text-[1.45rem]">
