...
const AvatarCard = ({
  ...
  return (
    <button
      ...
      disabled={busy}
      className={cn(
        "mx-auto inline-flex w-fit rounded-full bg-[linear-gradient(135deg,#a15523_0%,#f2dcab_100%)] p-1 shadow-[0_22px_40px_rgba(0,0,0,0.28)] transition hover:scale-[1.01]",
    ...
    <StitchCard tone="surface" className="rounded-xl p-5 sm:p-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <div className="mt-2 font-['Space_Grotesk'] text-[1.55rem] font-bold uppercase leading-[1.02] text-[#002637]">
            Hallenfortschritt
          </div>
        </div>
  ...
  <div className="mx-auto max-w-md space-y-6">
    <StitchCard tone="navy" className="p-5 text-[#f2dcab] sm:p-6">
      <div className="flex items-center gap-4">
        ...
        <div className="min-w-0 flex-1">
          <div className="stitch-kicker text-[rgba(242,220,171,0.62)]">Verlauf</div>
          ...
          <div className="mt-2 text-xs uppercase tracking-[0.18em] text-[rgba(242,220,171,0.66)]">
            {data.historyItems.length} Einträge insgesamt
          </div>
        </div>
      </div>
    ...
    <section className="space-y-4">
      <div className="flex items-center justify-between gap-4">
        <div className="stitch-kicker text-[#9aaab2]">Letzte Einträge</div>
...
export const ParticipantProfileContent = ({
  ...
  return (
    <div className="mx-auto max-w-md space-y-6">
      ...
      <section className="space-y-4">
        <div className="font-['Space_Grotesk'] text-[1.7rem] font-bold uppercase leading-none text-[#002637]">
          Hallen & Routen
        </div>
