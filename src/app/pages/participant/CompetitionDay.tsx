...
export default function CompetitionDay() {
  ...
  return <div className={pageClass}>
    ...
    {!readOnly && <p className="max-w-2xl text-sm leading-6 text-[#f2dcab]/75">Wähle die letzte sicher gehaltene Zone. {data.event.zone_points.every((points, index) => points === index) && "Zone 1–10 bringt 1–10 Punkte. "}Für den Flashbonus musst du die 10 im ersten Versuch erreichen. Danach scannst du hier den QR-Code beim Schiedsrichter.</p>}
