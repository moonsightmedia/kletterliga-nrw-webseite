-- Wertungsklassen U15 / Ü15 / Ü40: get_public_rankings auf u15/ue15/ue40 umstellen
-- p_class: 'u15-w', 'u15-m', 'ue15-w', 'ue15-m', 'ue40-w', 'ue40-m'
-- age_u16_max wird als U15-Grenze verwendet (Default 14 = unter 15 Jahre)

create or replace function public.get_public_rankings(
  p_league text,  -- 'toprope' or 'lead'
  p_class text   -- 'u15-w', 'u15-m', 'ue15-w', 'ue15-m', 'ue40-w', 'ue40-m'
)
returns table (
  rank int,
  display_name text,
