-- Fix: Public rankings zeigt keine Punkte
...
comment on function public.get_public_rankings(text, text) is
  'Returns top 50 ranking rows for public website by league and class. If qualification_start/end are not set, all results are included.';
