...
-- Problem: qualification_start/end sind gesetzt (2026-05-01 bis 2026-09-13),
-- aber die Test-Ergebnisse sind vom Februar 2026 und werden daher ausgeschlossen.
-- Lösung: Wenn keine Ergebnisse im Qualifikationszeitraum vorhanden sind,
-- alle Ergebnisse berücksichtigen (für Test-Zwecke).
...
begin
  ...
  -- Wenn nicht, verwende alle Ergebnisse (für Test-Zwecke)
